...
namespace Feijuca.Auth.Domain.Interfaces
{
    ...
    {
        Task<Result<bool>> AddClientRoleToGroupAsync(string groupId, string clientId, Guid roleId, string roleName, string tenant, CancellationToken cancellationToken);
