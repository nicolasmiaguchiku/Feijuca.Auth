...
{
    public class AddRoleToGroupCommandHandler(IGroupRepository groupRepository, IRoleGroupRepository roleGroupRepository, IRoleRepository roleRepository) : IRequestHandler<AddRoleToGroupCommand, Result<bool>>
    {
        private readonly IGroupRepository _groupRepository = groupRepository;
        private readonly IRoleGroupRepository _roleGroupRepository = roleGroupRepository;
